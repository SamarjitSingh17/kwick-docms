...
export const dummyEmployeeDashboardData = {
  role: "EMPLOYEE",
  productsAvailaible: 30,
  documentsAvailaible: 78,
  recentlyAddedDocs: 5,
  myDownloads: 3,
};
...
export const dummyEmployeeData = [
  ...
  {
    _id: "69b414a7f8a807df391d7c12",
    name: "Mei Lin",
    email: "mei@example.com",
    password: "$2b$10$hashedpassword010",
    role: "EMPLOYEE",
